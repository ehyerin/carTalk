...
<a href="${initParam.root }trade_list.do"><img src="${initParam.root }img/Qna.png" ></a>
<a href="${initParam.root }talk_list.do"><img src="${initParam.root }img/review.jpg" width="57" height="47" ></a>
</div>
